...
if (count($_POST)>0) {
$sql="UPDATE student_result set totalmarks='".$_POST['totalmarks']."',gainmarks='".$_POST['gainmarks']."',percentage='".$_POST['percentage']."' WHERE sid='".$_POST['sid']."' AND assessment='".$_POST['assessment']."' AND course='".$_POST['course']."'";
...
$recod= "SELECT * from student_result WHERE sid ='".$_GET['sid']."' AND assessment ='".$_GET['assessment']."' AND course ='".$_GET['course']."'";
